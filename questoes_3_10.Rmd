...
Nessa parte vamos provar que o algoritmo de fato gera valores da densida Epanechnikov. Sabemos que $U_i \sim U(-1,1)$, $i\in\{1,2,3\}$, daí a função de distribuição de $U_i$ é 
$$
F_U(u) = \frac{u+1}{2},
$$
